...
True Type Font: Small Dot Digital-7 version 1.0


EULA
-==-
The font Small Dot Digital-7 is freeware for home using only.


DESCRIPTION
-=========-
Original small rounded dot font.

Files in small_dot_digital-7.zip:
       	readme.txt    				this file;
        small_dot_digital-7.ttf    		regular font;
	small_dot_digital-7_screen.png		preview image.
