...
True Type Font: Modern Dot Digital-7 version 1.0


EULA
-==-
The font Modern Dot Digital-7 is freeware for home using only.


DESCRIPTION
-=========-
Original rounded dot font. Latin and Cyrillic code pages are supported.

Files in modern_dot_digital-7.zip:
       	readme.txt    				this file;
        modern_dot_digital-7.ttf    		regular font;
	modern_dot_digital-7_screen.png		preview image.
